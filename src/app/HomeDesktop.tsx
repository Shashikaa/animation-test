    ...
    const ctx = gsap.context(() => {
      ...
      const buildTimeline = () => {
        requestAnimationFrame(() => {
          // Prepare text splitting exact same way as About Page
          ...
          // Exact same play-once trigger logic as AboutDesktop
          ...
          // Helper method from About Page: fires smooth unscrubbed GSAP tween once section enters
          ...
          // ── SECTION 10 INTERNAL CONTENT DETAILS ──

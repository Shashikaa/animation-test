...
export default function ContactMobile() {
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      // Smoother dynamic ease without aggressive speed caps that cause sticking
      ...
      const { vh, h2, h3 } = scrollMetricsRef.current;
  ...
  return (
    <div ref={scopeRef} className="w-full bg-[#162D24] overscroll-none">
      <div ref={trackRef} className="contact-track-container relative w-full touch-pan-y">
        <div
          ref={fixedFrameRef}

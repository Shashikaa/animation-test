      ...
      */}
      ...
      <div className="section-container relative z-[2] h-full flex flex-col justify-between pb-10 md:pb-14 lg:pb-16">
        ...
        <div className="flex flex-col !mt-34">
          ...
          <p className="s1-reveal-top font-body text-[#F4EEDF] text-sm md:text-base !mt-4 lg:!mt-8">
            For Every Need
          </p>
        </div>
        ...
        <div className="flex justify-end">
          <p className="s1-reveal-bottom font-body text-[#F4EEDF] text-right max-w-[220px] md:max-w-[280px] lg:max-w-[280px] !mb-33 md:!mb-80 lg:!mb-20">

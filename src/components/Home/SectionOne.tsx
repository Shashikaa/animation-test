...
export default function SectionOne() {
  return (
    <section className="relative w-full h-full overflow-hidden">
      {/* Desktop image */}
      <div
        className="s1-bg absolute left-0 right-0 bg-cover bg-center will-change-transform hidden md:block"
        style={{ top: "-10%", bottom: "-10%", backgroundImage: "url('/pool.webp')" }}
      />

      {/* Mobile image */}
      <div
        className="s1-bg absolute left-0 right-0 bg-cover bg-top will-change-transform block md:hidden"

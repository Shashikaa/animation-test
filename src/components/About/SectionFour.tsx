  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div
        ...
        style={{ top: "-10%", bottom: "-10%", backgroundImage: "url('/about.webp')" }}
      />
      ...
      <div className="section-continer relative z-[1] h-full flex items-start md:items-end px-4 md:px-8 lg:px-0 !pt-32 md:!pt-20 lg:!pb-50">
        <div
          className="w-full max-w-[250px] md:max-w-[340px] lg:max-w-[360px] h-auto md:h-[148px] lg:h-[164px] !pl-6 md:!pl-6 lg:!pl-6 !pr-6 md:!pr-6 lg:!pr-6 !py-6 md:!py-7 lg:!py-8 flex flex-col justify-center gap-4 will-change-transform"
          style={{

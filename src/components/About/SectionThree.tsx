    ...
    >
      ...
      <div className="section-continer relative z-[2] h-full flex flex-col justify-between pb-10 md:pb-14 lg:pb-16">
        ...
        <div className="flex flex-col !mt-44">
          <h2 
            className="s3-reveal-top font-display text-[#F4EEDF] leading-[1.2] !font-[100]"
            style={{ visibility: "hidden" }}
          >
             Built on Trust <br />
          </h2>
          <p 
            className="s3-reveal-top font-body text-[#F4EEDF] text-sm md:text-base !mt-3"
            style={{ visibility: "hidden" }}
          >
        ...
        <div className="flex justify-end">
          <p 
            className="s3-reveal-bottom font-body text-[#F4EEDF] text-left max-w-[220px] md:max-w-[280px] lg:max-w-[280px] !mb-33 md:!mb-80 lg:!mb-0"
            style={{ visibility: "hidden" }}
          >
